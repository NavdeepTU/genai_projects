# Agent Ops Platform — Interview Prep
...
No features have been built yet, so there's nothing to review here so
far. A new section gets added here after each major feature is completed
— see the "Interview Prep Document" rule in CLAUDE.md.

---

## General concepts worth being able to explain from memory

(To be filled in as features are built.)
